                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <div class="w-100 mw-150px">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                                ...
                                @foreach ($select_kategori as $select)
                                    <option value="{{ $select->nama_kategori }}">{{ $select->nama_kategori }}</option>
                                @endforeach
                            </select>
                            <!--end::Select2-->
                        </div>
                        <!--begin::Add product-->
                        <a href="{{ route('admins.add.add-product') }}" class="btn btn-success">Tambah</a>
                        <!--end::Add product-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-5">
                                                    <!--begin::Title-->
                                                    <a href=""
                                                        class="text-gray-800 text-hover-primary800 fs-5 fw-bold"
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admins.cetak', ['kode_barang' => $item->kode_barang]) }}"
                                                        class="menu-link px-3">Cetak Kartu</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    ...
                                                    <a href="javascript:void(0)" class="menu-link px-3"
                                                        onclick="confirmDelete('{{ $item->kode_barang }}', '{{ $item->nama_barang }}')">Delete</a>
                                                </div>

                                                <!-- Form for deletion -->
                                                <form id="delete-form-{{ $item->kode_barang }}" action=""
