            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-gray-700 fw-bold lh-1">Daftar Satuan</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                    <!--begin::Title-->
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        <a href="{{ route('admin.satuan.create') }}" class="btn btn-sm btn-success ms-3 px-4 py-3">
                            Tambah Satuan
                        </a>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <a href="javascript:void(0)" class="menu-link px-3"
                                                    onclick="confirmDelete('{{ $item->kode_satuan }}', '{{ $item->nama_satuan }}')">Delete</a>
                                            </div>

                                            <!-- Form for deletion -->
                                            <form id="delete-form-{{ $item->kode_satuan }}"
                                                action="{{ route('admin.satuan.destroy', ['kode_satuan' => $item->kode_satuan]) }}"
...
<script>
    ...
    function confirmDelete(kode_satuan, nama_satuan) {
 

        Swal.fire({

            text: "Are you sure you want to delete " + nama_satuan + "?",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                document.getElementById('delete-form-' + kode_satuan).submit();
            }
        });
    }
</script>
