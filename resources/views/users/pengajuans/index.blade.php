            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <!--begin::Add product-->
                        <a href="{{ route('users.pengajuans.create') }}" class="btn btn-primary">Buat Pengajuan</a>
                        <!--end::Add product-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-200px">No_Nota</th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            @foreach ($groupedPengajuan as $noNota => $items)
                                <tr data-bs-toggle="collapse" data-bs-target=".details{{ $noNota }}" aria-expanded="false" class="accordion-toggle">
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-5">
                                                <!--begin::Title-->
                                                <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{ $noNota }}</a>
                                                <!--end::Title-->
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr class="hiddenRow">
                                    <td colspan="5">
                                        <div class="accordian-body collapse details{{ $noNota }}">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="heading{{ $item->id }}">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $item->id }}" aria-expanded="true" aria-controls="collapse{{ $item->id }}">
                                                        Kode Barang: {{ $item->Kode_Barang }} - Nama Barang: {{ $item->Nama_Barang }} - Kategori: {{ $item->Kategori }} - Satuan: {{ $item->Satuan }} - Jumlah: {{ $item->Jumlah }}
                                                    </button>
                                                </h2>
                                                <div id="collapse{{ $item->id }}" class="accordion-collapse collapse" aria-labelledby="heading{{ $item->id }}" data-bs-parent="#details{{ $noNota }}">
